                ...
                <div className="container max-w-6xl mx-auto">
                    <div className="grid grid-cols-4 gap-8 mt-4 px-4 sm:grid-cols-8 lg:grid-cols-12 sm:px-8 xl:px-0">
                        ...
                        <div className="relative flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 overflow-hidden bg-[#f7f4e9] rounded-xl">
                            ...
                            <p className="text-lg text-center text-[#1e1e31]">Starting a brand new season 4 with F1 2022 on the PS platform RPM roars into life again created by a very friendly group of enthusiastic sim racers who are all ready to welcome drivers of all abilities to our RPM Esports F1 Racing League.</p><br></br>
                        </div>
